...
namespace TestLibrary
{
    ...
    public class SongTest
    {
        ...
        public object SongGenre { get; private set; }
        public string SongName { get; private set; }
        public object AllSongs { get; private set; }
        [TestMethod]
        ...
        public void SongAlbumMaxPlusOne()
        {
            //create an instance of the class we want to create
            clsSong ASong = new clsSong();
            //string variable to store the result of the validation
            String Error = "";
        ...
        [TestMethod]
        public void SongAlbumMid()
        {
            //create an instance of the class we want to create
            clsSong ASong = new clsSong();
            //string variable to store any error message 
            String Error = "";
            //test assigned to property
            string SongName = "Difference";
            string SongArtist = "Amrit Maan";
            string SongAlbum = "Testinggggggggg";
            string SongGenre = "Bhangra";
            //invoke the method 
            Error = ASong.Valid(SongName, SongArtist, SongAlbum, SongGenre);
            //test to see that the result is correct
        ...
        [TestMethod]
        public void SongGenreMinLessOne()
        {
            //create an instance of the class we want to create
            clsSong ASong = new clsSong();
            //string variable to store any error message
        ...
        [TestMethod]
        public void SongGenreMinPlusOne()
        {
        ...
        [TestMethod]
        public void SongGenreMaxLessOne()
        {
            //create an instance of the class we want to create
            clsSong ASong = new clsSong();
            //string variable to store any error message
        ...
        [TestMethod]
        public void TwoSongsPresent()
        {
            //create an instance of the class we want to create
            clsSongCollection Songs = new clsSongCollection();
            //test to see that the two values are the same 
            Assert.AreEqual(Songs.Count, 2);
        }
